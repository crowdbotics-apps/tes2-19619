...
admin.site.site_header = "tes2"
admin.site.site_title = "tes2 Admin Portal"
admin.site.index_title = "tes2 Admin"

# swagger
api_info = openapi.Info(
    title="tes2 API",
    default_version="v1",
    description="API documentation for tes2 App",
)
